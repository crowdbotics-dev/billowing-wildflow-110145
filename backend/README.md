...
## Project Structure
    ...
    ├── billowing_wildflow_110145  # Django project configurations
...
1. Clone this repo and `cd billowing_wildflow_110145`
...
2. Clone this repo and `cd billowing_wildflow_110145`
